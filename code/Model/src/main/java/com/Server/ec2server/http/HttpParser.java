        ...
        while((_byte = reader.read()) >= 0){
            ...
            if(_byte == SP){
                ...
                if(!methodParsed) {
                    ...
                    LOGGER.debug("Request Line REQ: {}", processingDataBuffer.toString());
                ...
                if(!methodParsed && processingDataBuffer.length() > MAX_LENGTH) throw new HttpParsingException(HttpStatusCode.SERVER_ERROR_501_NOT_IMPLEMENTED);
